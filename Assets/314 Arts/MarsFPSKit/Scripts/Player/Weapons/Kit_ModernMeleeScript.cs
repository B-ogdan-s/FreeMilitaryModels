        ...
        public class Kit_ModernMeleeScript : Kit_WeaponBase
        {
            ...
            public override float BeginQuickUse(Kit_PlayerBehaviour pb, object runtimeData)
            {
                if (runtimeData != null && runtimeData.GetType() == typeof(MeleeControllerRuntimeData))
                {
                    ...
                    {
                        //Start Coroutine!
                        Kit_ScriptableObjectCoroutineHelper.instance.StartCoroutine(Kit_ScriptableObjectCoroutineHelper.instance.MeleeExecuteStab(this, data, quickAttackSettings, pb));
                    ...
                    {
                        //Start Coroutine!
                        Kit_ScriptableObjectCoroutineHelper.instance.StartCoroutine(Kit_ScriptableObjectCoroutineHelper.instance.MeleeExecuteHeal(this, data, quickAttackSettings, pb));
            ...
            public override float EndQuickUse(Kit_PlayerBehaviour pb, object runtimeData)
            {
                if (runtimeData != null && runtimeData.GetType() == typeof(MeleeControllerRuntimeData))
                {
                    ...
                    {
                        //Finish him.
                        Kit_ScriptableObjectCoroutineHelper.instance.StartCoroutine(Kit_ScriptableObjectCoroutineHelper.instance.MeleeExecuteCharge(this, data, quickAttackSettings, pb));
            ...
            public override void CalculateWeaponUpdate(Kit_PlayerBehaviour pb, object runtimeData)
            {
                if (runtimeData != null && runtimeData.GetType() == typeof(MeleeControllerRuntimeData))
                {
                            ...
                            if (primaryAttack == AttackType.Stab)
                            {
                                ...
                                if (data.lastLmb != pb.input.lmb)
                                {
                                    ...
                                    if (pb.input.lmb)
                                    {
                                        ...
                                        {
                                            Kit_ScriptableObjectCoroutineHelper.instance.StartCoroutine(Kit_ScriptableObjectCoroutineHelper.instance.MeleeExecuteStab(this, data, primaryAttackSettings, pb));
                                        }
                                    }
                                }
                            }
                            else if (primaryAttack == AttackType.Charge)
                            {
                                if (!data.chargingSecondary)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            //RELEASE...
                                            Kit_ScriptableObjectCoroutineHelper.instance.StartCoroutine(Kit_ScriptableObjectCoroutineHelper.instance.MeleeExecuteCharge(this, data, primaryAttackSettings, pb));
                                            //Reset bools
                            ...
                            else if (primaryAttack == AttackType.Heal)
                            {
                                ...
                                if (data.lastLmb != pb.input.lmb)
                                {
                                    ...
                                    if (pb.input.lmb)
                                    {
                                        ...
                                        {
                                            Kit_ScriptableObjectCoroutineHelper.instance.StartCoroutine(Kit_ScriptableObjectCoroutineHelper.instance.MeleeExecuteHeal(this, data, primaryAttackSettings, pb));
                                        }
                                    }
                                }
                            }
                                    ...
                                    if (pb.input.lmb)
                                    {
                                        if (Time.time > data.nextActionPossibleAt && !data.isCharging)
                                        {
                                            if (primaryAttackSettings.combos.Length > 0)
                                            {
                                                ...
                                                Kit_ScriptableObjectCoroutineHelper.instance.StartCoroutine(Kit_ScriptableObjectCoroutineHelper.instance.MeleeExecuteCombo(this, data, primaryAttackSettings, true, pb));
                                            }
                                            else
                                            {
                            ...
                            if (secondaryAttack == AttackType.Stab)
                            {
                                ...
                                if (data.lastRmb != pb.input.rmb)
                                {
                                    ...
                                    if (pb.input.rmb)
                                    {
                                        if (Time.time > data.nextActionPossibleAt && !data.isCharging)
                                        {
                                            Kit_ScriptableObjectCoroutineHelper.instance.StartCoroutine(Kit_ScriptableObjectCoroutineHelper.instance.MeleeExecuteStab(this, data, secondaryAttackSettings, pb));
                                        }
                                    }
                                }
                            }
                            else if (secondaryAttack == AttackType.Charge)
                            {
                                if (!data.chargingPrimary)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            //RELEASE...
                                            Kit_ScriptableObjectCoroutineHelper.instance.StartCoroutine(Kit_ScriptableObjectCoroutineHelper.instance.MeleeExecuteCharge(this, data, secondaryAttackSettings, pb));
                                            //Reset bools
                                            data.isCharging = false;
                            ...
                            else if (secondaryAttack == AttackType.Heal)
                            {
                                ...
                                if (data.lastRmb != pb.input.rmb)
                                {
                                    ...
                                    if (pb.input.rmb)
                                    {
                                        ...
                                        {
                                            Kit_ScriptableObjectCoroutineHelper.instance.StartCoroutine(Kit_ScriptableObjectCoroutineHelper.instance.MeleeExecuteHeal(this, data, secondaryAttackSettings, pb));
                                        }
                                    }
                                }
                            }
                                    ...
                                    if (pb.input.lmb)
                                    {
                                        if (Time.time > data.nextActionPossibleAt && !data.isCharging)
                                        {
                                            if (secondaryAttackSettings.combos.Length > 0)
                                            {
                                                ...
                                                Kit_ScriptableObjectCoroutineHelper.instance.StartCoroutine(Kit_ScriptableObjectCoroutineHelper.instance.MeleeExecuteCombo(this, data, secondaryAttackSettings, false, pb));
                                            }
                                            else
                                            {
                    ...
                    if (pb.isFirstPersonActive)
                    {
                        ...
                        {
                            pb.main.hud.DisplayAmmo(data.primaryHealingAmount, data.secondaryHealingAmount);
                        }
                        else if (primaryAttack == AttackType.Heal)
                        {
                            pb.main.hud.DisplayAmmo(data.primaryHealingAmount, 0);
                        }
                        else if (secondaryAttack == AttackType.Heal)
                        {
                            pb.main.hud.DisplayAmmo(0, data.secondaryHealingAmount);
                        }
                        else
                        {
            ...
            public override void NetworkMeleeHealRPCReceived(Kit_PlayerBehaviour pb, object runtimeData, int slot)
            {
                if (!pb.photonView.IsMine)
                {
                    if (runtimeData != null && runtimeData.GetType() == typeof(MeleeControllerRuntimeData))
