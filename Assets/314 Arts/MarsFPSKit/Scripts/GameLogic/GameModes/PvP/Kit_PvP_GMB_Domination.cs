...
namespace MarsFPSKit
{
    ...
    public class Kit_PvP_GMB_Domination : Kit_PvP_GameModeBase
    {
        ...
        /// <summary>
        /// Should spawns near captured flags be used?
        /// </summary>
        [Tooltip("Should spawns near captured flags be used?")]
        public bool useSpawnsNearCapturedFlags = true;
        /// <summary>
